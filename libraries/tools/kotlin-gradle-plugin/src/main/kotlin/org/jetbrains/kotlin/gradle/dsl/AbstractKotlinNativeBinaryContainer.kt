...
abstract class AbstractKotlinNativeBinaryContainer : DomainObjectSet<NativeBinary> {
    ...
    /** Returns an Objective-C frameworks with the given [namePrefix] and the given build type. Throws an exception if there is no such binary.*/
    ...
    /** Returns an Objective-C frameworks with the empty name prefix and the given build type. Throws an exception if there is no such binary.*/
    ...
    /** Returns an Objective-C frameworks with the given [namePrefix] and the given build type. Returns null if there is no such binary. */
    ...
    /** Returns an Objective-C frameworks with the empty name prefix and the given build type. Returns null if there is no such binary. */
    ...
    /** Creates an Objective-C frameworks with the given [namePrefix] for each build type and configures it. */
    @JvmOverloads
    fun framework(
        namePrefix: String,
        buildTypes: Collection<NativeBuildType> = NativeBuildType.DEFAULT_BUILD_TYPES,
    ...
    /** Creates an Objective-C frameworks with the empty name prefix for each build type and configures it. */
    @JvmOverloads
    fun framework(
        buildTypes: Collection<NativeBuildType> = NativeBuildType.DEFAULT_BUILD_TYPES,
        configure: Framework.() -> Unit = {}
    ...
    /** Creates an Objective-C frameworks with the default name prefix for each build type and configures it. */
    @JvmOverloads
    fun framework(
        buildTypes: Collection<NativeBuildType> = NativeBuildType.DEFAULT_BUILD_TYPES,
        configureClosure: Closure<*>
